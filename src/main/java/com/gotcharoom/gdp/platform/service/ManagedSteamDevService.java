...
@Service
public class ManagedSteamDevService extends ManagedPlatformService {

    public ManagedSteamDevService(
    ...
    public PlatformType getPlatformType() {
        return PlatformType.STEAM_DEV;
    }

    @Override
    public void createPlatformUserCert(PlatformCallbackRequest request, GdpUser user) {

        Platform platform = platformRepository.findByType(PlatformType.STEAM_DEV).orElseThrow();
